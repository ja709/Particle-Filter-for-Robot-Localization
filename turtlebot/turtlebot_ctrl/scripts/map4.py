...
obstacle1 = [(-8,9), (2,9), (1,8), (-8,8)]
obstacle2 = [(-3,4), (-3,1), (-4,1), (-4,5)]
obstacle3 = [(-3,5),(-3,1), (-4,1), (-4,5) ]
obstacle4 = [(2,7), (2,-2), (1,0), (1,6)]
obstacle5 = [(0,-1), (0,-2), (-6,-1), (-6,0)]
obstacle6 = [(8,7), (4,1), (5,-2), (4,-4), (3,2)]
obstacle7 = [(-8,6), (-6,-1), (-6,-4), (-7,-7)]
obstacle8 = [(10,0), (7,-6), (1,-7), (6,-5)]
obstacle9 = [(0,-5), (-4,-9), (-5,-6)]
obstacle10 = [(-3,2), (1,5), (0,3), (-2,1)]
obstacle11 = [(7,10), (4,6), (4,7), (6,10)]
...
def iterateshow(self):
    ...
    # obstacle#1
    plt.plot([-8, 2, 1, -8, -8], [9, 9, 8, 8, 9], 'c-')
    # obstacle#2
    plt.plot([-2, -2, -3, -3,-2], [8, 5, 6, 8,8], 'c-')
    # obstacle#3
    plt.plot([-3, -3, -4, -4, -3], [4, 1, 1, 5, 4], 'c-')
    #obstacle#4
    plt.plot([2,2,1,1,2], [7,-2,0,6,7], 'c-')
    # obstacle#5
    plt.plot([0,0,-6,-6,0], [-1,-2,-1,0,-1], 'c-')
    # obstacle#6
    plt.plot([8,4,5,4,3,8], [7,1,-2,-4,2,7], 'c-')
    # obstacle#7
    plt.plot([-8,-6,-6,-7,-8], [6,-1,-4,-7,6], 'c-')
    #obstacle#8
    plt.plot([10,7,1,6,10], [0,-6,-7,-5,0], 'c-')
    # obstacle#9
    plt.plot([0,-4,-5,0], [-5,-9,-6,-5], 'c-')
    # obstacle#10
    plt.plot([-3,1,0,-2,-3], [2,5,3,1,2], 'c-')
    #obstacle#11
    plt.plot([7,4,4,6,7], [10,6,7,10,10], 'c-')
    listofweight = []
    for key in particles.keys():
