...
obstacle1 = [(-7,9), (0,8), (1,6), (-6,8)]
obstacle2 = [(4,1), (6,9), (9,9), (5,2)]
obstacle3 = [(-2,4), (2,5), (3,4), (-2,3)]
obstacle4 = [(-8,5), (-6,6), (-4,4), (-6,2)]
obstacle5 = [(0,3), (4,-1), (2,-5)]
obstacle6 = [(8,4), (9,3), (9,-6), (8,-6)]
obstacle7 = [(5,-2), (6,-1), (6,-6), (5,-7), (4,-5)]
obstacle8 = [(-6,0), (-3,-2), (0,-3), (-3,-4)]
obstacle9 = [(-7,-5), (-2,-6), (0,-5), (1,-7), (-5,-6)]
...
def generateParticles(self,n):
    ...
    for i in range(n):
        ...
        if inside_polygon(x,y, obstacle1) or inside_polygon(x,y, obstacle2) or inside_polygon(x,y, obstacle3) or inside_polygon(x,y,obstacle4) or inside_polygon(x,y,obstacle5)or inside_polygon(x,y, obstacle6)or inside_polygon(x,y, obstacle7)or inside_polygon(x,y, obstacle8)or inside_polygon(x,y, obstacle9):
            continue
...
def iterateshow(self):
    ...
    # obstacle#1
    plt.plot([-7, 0, 1, -6, -7], [9, 8, 6, 8, 9], 'c-')
    # obstacle#2
    plt.plot([4, 6, 9, 5, 4], [1, 9, 9, 2,1], 'c-')
    # obstacle#3
    plt.plot([-2, 2, 3, -2, -2], [4, 5, 4,3, 4], 'c-')
    #obstacle#4
    plt.plot([-8,-6,-4,-6,-8], [5,6,4,2,5], 'c-')
    # obstacle#5
    plt.plot([0,4,2,0], [3,-1,-5,3], 'c-')
    # obstacle#6
    plt.plot([8,9,9,8,8], [4,3,-6,-6,4], 'c-')
    # obstacle#7
    plt.plot([5,6,6,5,4,5], [-2,-1,-6,-7,-5,-2], 'c-')
    #obstacle#8
    plt.plot([-6,-3,0,-3,-6], [0,-2,-3,-4,0], 'c-')
    # obstacle#9
    plt.plot([-7,-2,0,1,-5,-7], [-5,-6,-5,-7,-6,-5], 'c-')
